      ...
      <div class="card rounded">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-2">
            <div>
              <img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/images/'.$profileData->photo) : url('upload/images/no_image.jpg') }}" alt="profile">
          ...
          <div class="card rounded">
            ...
            <div class="card-body">
                ...
                class="forms-sample" enctype="multipart/form-data">
                  @csrf
                  <div class="mb-3">
                    <label for="exampleInputUsername1" class="form-label">Stare hasło</label>
                ...
                <div class="mb-3">
                    <label for="exampleInputUsername1" class="form-label">Nowe hasło</label>
                ...
                <div class="mb-3">
                    <label for="exampleInputUsername1" class="form-label">Potwierdź nowe hasło</label>
